...
var file_device_proto_rawDesc = []byte{
	...
	,
...
var file_device_proto_goTypes = []interface{}{
	(*IdReq)(nil),      // 0: device.IdReq
	(*DeviceInfo)(nil), // 1: device.DeviceInfo
}
var file_device_proto_depIdxs = []int32{
	0, // 0: device.device.GetDeviceInfoById:input_type -> device.IdReq
	1, // 1: device.device.GetDeviceInfoById:output_type -> device.DeviceInfo
...
func (c *deviceClient) GetDeviceInfoById(ctx context.Context, in *IdReq, opts ...grpc.CallOption) (*DeviceInfo, error) {
	out := new(DeviceInfo)
	err := c.cc.Invoke(ctx, "/device.device/GetDeviceInfoById", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DeviceServer interface {
	GetDeviceInfoById(context.Context, *IdReq) (*DeviceInfo, error)
}
...
func (*UnimplementedDeviceServer) GetDeviceInfoById(context.Context, *IdReq) (*DeviceInfo, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetDeviceInfoById not implemented")
}
...
func _Device_GetDeviceInfoById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(IdReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DeviceServer).GetDeviceInfoById(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/device.device/GetDeviceInfoById",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DeviceServer).GetDeviceInfoById(ctx, req.(*IdReq))
	}
...
var _Device_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetDeviceInfoById",
			Handler:    _Device_GetDeviceInfoById_Handler,
		},
	},
