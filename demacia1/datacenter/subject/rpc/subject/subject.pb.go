...
func (x *SubjectInfo) GetTitle() string {
	if x != nil {
		return x.Title
	}
	return ""
...
var file_subject_proto_rawDesc = []byte{
	...
	,
...
var file_subject_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_subject_proto_goTypes = []interface{}{
	(*IdReq)(nil),       // 0: subject.IdReq
	(*SubjectInfo)(nil), // 1: subject.SubjectInfo
	(*NullResp)(nil),    // 2: subject.NullResp
}
var file_subject_proto_depIdxs = []int32{
	0, // 0: subject.subject.GetSubjectById:input_type -> subject.IdReq
	1, // 1: subject.subject.GetSubjectById:output_type -> subject.SubjectInfo
...
func (c *subjectClient) GetSubjectById(ctx context.Context, in *IdReq, opts ...grpc.CallOption) (*SubjectInfo, error) {
	out := new(SubjectInfo)
	err := c.cc.Invoke(ctx, "/subject.subject/GetSubjectById", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SubjectServer interface {
	GetSubjectById(context.Context, *IdReq) (*SubjectInfo, error)
}

// UnimplementedSubjectServer can be embedded to have forward compatible implementations.
type UnimplementedSubjectServer struct {
}

func (*UnimplementedSubjectServer) GetSubjectById(context.Context, *IdReq) (*SubjectInfo, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetSubjectById not implemented")
}

func RegisterSubjectServer(s *grpc.Server, srv SubjectServer) {
	s.RegisterService(&_Subject_serviceDesc, srv)
}

func _Subject_GetSubjectById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(IdReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SubjectServer).GetSubjectById(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/subject.subject/GetSubjectById",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SubjectServer).GetSubjectById(ctx, req.(*IdReq))
	}
	return interceptor(ctx, in, info, handler)
}

var _Subject_serviceDesc = grpc.ServiceDesc{
	ServiceName: "subject.subject",
	HandlerType: (*SubjectServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetSubjectById",
			Handler:    _Subject_GetSubjectById_Handler,
		},
	},
