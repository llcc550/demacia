...
var (
	...
	cacheEventEventIdPrefix  = "cache:urgentevent:event:id:"
	cacheEventOrgIdPrefix    = "cache:urgentevent:event:org-id:"
	cacheEventCateIdPrefix   = "cache:urgentevent:event:category-id:"
	cacheEventPushTypePrefix = "cache:urgentevent:event:push-type:"
)
...
func NewEventModel(conn sqlx.SqlConn, cache *redis.Redis) *EventModel {
	return &EventModel{
		CachedModel: cachemodel.NewCachedModel(conn, `"urgentevent"."event"`, cache),
	}
}
