...
var file_websocket_proto_rawDesc = []byte{
	...
	0x6f, 0x12, 0x09, 0x77, 0x65, 0x62, 0x73, 0x6f, 0x63, 0x6b, 0x65, 0x74, 0x22, 0x41, 0x0a, 0x07,
	...
	0x06, 0x0a, 0x04, 0x4e, 0x75, 0x6c, 0x6c, 0x32, 0x38, 0x0a, 0x09, 0x57, 0x65, 0x62, 0x73, 0x6f,
	0x63, 0x6b, 0x65, 0x74, 0x12, 0x2b, 0x0a, 0x04, 0x50, 0x75, 0x73, 0x68, 0x12, 0x12, 0x2e, 0x77,
	0x65, 0x62, 0x73, 0x6f, 0x63, 0x6b, 0x65, 0x74, 0x2e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x1a, 0x0f, 0x2e, 0x77, 0x65, 0x62, 0x73, 0x6f, 0x63, 0x6b, 0x65, 0x74, 0x2e, 0x4e, 0x75, 0x6c,
	0x6c, 0x42, 0x0b, 0x5a, 0x09, 0x77, 0x65, 0x62, 0x73, 0x6f, 0x63, 0x6b, 0x65, 0x74, 0x62, 0x06,
...
var file_websocket_proto_goTypes = []interface{}{
	(*Request)(nil), // 0: websocket.Request
	(*Null)(nil),    // 1: websocket.Null
}
var file_websocket_proto_depIdxs = []int32{
	0, // 0: websocket.Websocket.Push:input_type -> websocket.Request
	1, // 1: websocket.Websocket.Push:output_type -> websocket.Null
...
func (c *websocketClient) Push(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Null, error) {
	out := new(Null)
	err := c.cc.Invoke(ctx, "/websocket.Websocket/Push", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type WebsocketServer interface {
	Push(context.Context, *Request) (*Null, error)
}
...
func (*UnimplementedWebsocketServer) Push(context.Context, *Request) (*Null, error) {
...
func _Websocket_Push_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/websocket.Websocket/Push",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WebsocketServer).Push(ctx, req.(*Request))
	}
